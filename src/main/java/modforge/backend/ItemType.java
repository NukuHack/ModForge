...
public enum ItemType {
	...
	private static class MasterData {
		...
		private void initializeTableMappings() {
			// Giant table mapping
			Map<String, Class<? extends ModItem>> mappings = Map.<String, Class<? extends ModItem>>ofEntries(
					Map.entry("ammo", Ammo.class),
					Map.entry("armor", Armor.class),
					Map.entry("armors", Armor.class),
					Map.entry("buff", Buff.class),
					Map.entry("buffs", Buff.class),
					Map.entry("craftingmaterial", CraftingMaterial.class),
					Map.entry("craftingmaterials", CraftingMaterial.class),
					Map.entry("dicebadge", DiceBadge.class),
					Map.entry("dicebadges", DiceBadge.class),
					Map.entry("die", Die.class),
					Map.entry("dice", Die.class),
					Map.entry("food", Food.class),
					Map.entry("foods", Food.class),
					Map.entry("gamedocument", GameDocument.class),
					Map.entry("gamedocuments", GameDocument.class),
					Map.entry("helmet", Helmet.class),
					Map.entry("helmets", Helmet.class),
					Map.entry("herb", Herb.class),
					Map.entry("herbs", Herb.class),
					Map.entry("hood", Hood.class),
					Map.entry("hoods", Hood.class),
					Map.entry("itemalias", ItemAlias.class),
					Map.entry("itemaliases", ItemAlias.class),
					Map.entry("key", Key.class),
					Map.entry("keys", Key.class),
					Map.entry("keyring", KeyRing.class),
					Map.entry("keyrings", KeyRing.class),
					Map.entry("meleeweapon", MeleeWeapon.class),
					Map.entry("meleeweapons", MeleeWeapon.class),
					Map.entry("meleeweaponclass", MeleeWeaponClass.class),
					Map.entry("meleeweaponclasses", MeleeWeaponClass.class),
					Map.entry("misc", MiscItem.class),
					Map.entry("miscitem", MiscItem.class),
					Map.entry("miscitems", MiscItem.class),
					Map.entry("missileweapon", MissileWeapon.class),
					Map.entry("missileweapons", MissileWeapon.class),
					Map.entry("missileweaponclass", MissileWeaponClass.class),
					Map.entry("missileweaponclasses", MissileWeaponClass.class),
					Map.entry("money", Money.class),
					Map.entry("npctool", NPCTool.class),
					Map.entry("npctools", NPCTool.class),
					Map.entry("perk", Perk.class),
					Map.entry("perks", Perk.class),
					Map.entry("perkbuff", PerkBuff.class),
					Map.entry("perkbuffs", PerkBuff.class),
					Map.entry("perkscript", PerkScript.class),
					Map.entry("perkscripts", PerkScript.class),
					Map.entry("pickableitem", PickableItem.class),
					Map.entry("pickableitems", PickableItem.class),
					Map.entry("poison", Poison.class),
					Map.entry("poisons", Poison.class),
					Map.entry("quickslotcontainer", QuickSlotContainer.class),
					Map.entry("quickslotcontainers", QuickSlotContainer.class),
					Map.entry("storm", Storm.class),
					Map.entry("storms", Storm.class),
					Map.entry("weapon", MeleeWeapon.class),
					Map.entry("weapons", MeleeWeapon.class)
			);
		...
		private void initializeDisplays() {
			...
			allClasses.stream()
					...
					.forEach(itemDisplays::add);
		}

		private static final Set<Class<? extends ModItem>> exclude = Set.of(
				MeleeWeaponClass.class,
				MissileWeaponClass.class,
				PerkBuff.class,
				PerkScript.class,
				Storm.class
		);
