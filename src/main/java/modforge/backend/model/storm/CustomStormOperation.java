...
public final class CustomStormOperation {
    ...
    public List<ModAttribute> getModAttributes() { return modAttributes; }
    ...
    public static final class ModAttribute {
        ...
        public double getMinMod() { return minMod; }
        public void   setMinMod(double minMod) { this.minMod = minMod; }

        public double getMaxMod() { return maxMod; }
        public void   setMaxMod(double maxMod) { this.maxMod = maxMod; }
