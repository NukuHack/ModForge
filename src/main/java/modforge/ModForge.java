...
class Perk extends BaseModItem {
}

class Buff extends BaseModItem {
}

class MeleeWeapon extends BaseModItem {
}

class MissileWeapon extends BaseModItem {
}

class Ammo extends BaseModItem {
}

class MeleeWeaponClass extends BaseModItem {
}

class MissileWeaponClass extends BaseModItem {
}

class Hood extends BaseModItem {
}

class Armor extends BaseModItem {
}

class Helmet extends BaseModItem {
}

class Food extends BaseModItem {
}

class Poison extends BaseModItem {
}

class Herb extends BaseModItem {
}

class CraftingMaterial extends BaseModItem {
}

class NPCTool extends BaseModItem {
}

class MiscItem extends BaseModItem {
}

// Named GameDocument to avoid collision with org.w3c.dom.Document
class GameDocument extends BaseModItem {
}

class Die extends BaseModItem {
}

class ItemAlias extends BaseModItem {
}

class QuickSlotContainer extends BaseModItem {
}

class DiceBadge extends BaseModItem {
}

class PickableItem extends BaseModItem {
}

class Key extends BaseModItem {
}

class Money extends BaseModItem {
}

class KeyRing extends BaseModItem {
}
...
final class AttributeFactory {
	...
	private static final Pattern BUFF_PARAM_RE =
	...
	private static Class<?> inferType(String name, String value) {
		...
		if (lo.equals("id") || lo.endsWith("id")) return String.class;
...
final class DdsConverter implements Closeable {
	 ...
	 * your build system:
	 * - DDSReader (lightweight, MIT): https://github.com/npedotnet/DDSReader
