...
public class HomePage extends BasePage {
	public HomePage(MainWindow w) {
		...
		btns.add(primaryBtn("Open Mods", e -> w.navigate(MainWindow.PAGE_MODS)));
		btns.add(primaryBtn("Browse Items", e -> w.navigate(MainWindow.PAGE_ITEMS)));
		btns.add(primaryBtn("Settings", e -> w.navigate(MainWindow.PAGE_SETTINGS)));
